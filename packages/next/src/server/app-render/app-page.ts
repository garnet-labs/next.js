...
import type { AppPageRouteHandlerContext } from '../route-modules/app-page/module.compiled'
import type { AppPageRouteModule } from '../route-modules/app-page/module.compiled'
import type { RequestMeta } from '../request-meta'
import type { CacheControl } from '../lib/cache-control'
import type { Span } from '../lib/trace/tracer'
import type {
  CachedAppPageValue,
  CachedPageValue,
  ResponseCacheEntry,
...
import type * as entryBase from './entry-base'
...
import { stripFlightHeaders } from './strip-flight-headers'
...
export { buildDynamicSegmentPlaceholder } from '../request/fallback-params'
import { setManifestsSingleton } from './manifests-singleton'
import {
  isHtmlBotRequest,
...
import { createInstantTestScriptInsertionTransformStream } from '../stream-utils/node-web-streams-helper'
 ...
 */
export function buildCompletedShellCacheKey(
...
export function createHandler(
  ...
  moduleEntryBase: typeof entryBase,
  tree: LoaderTree,
  __next_app__: NextApp
) {
  async function handler(
    ...
    let srcPage = routeModule.definition.page
          ...
          // not set already.
            ...
            if (typeof cacheEntry.cacheControl.revalidate === 'number') {
              ...
              cacheControl = {
                ...
                expire:
                  cacheEntry.cacheControl?.expire ?? nextConfig.expireTime,
              }
            }
